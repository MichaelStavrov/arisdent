        ...
        <div className={classes.personInfo}>
          ...
          <div className={classes.personDescription}>
            ...
            <p className={classes.mainPersonDescription}>
              Врач стоматолог широкого профиля, имеющий дополнительную
              подготовку по смежным специальностям и большой опыт работы в
              государственных учреждениях и в частных сетевых клиниках
            </p>
          </div>
        </div>
        ...
        <div className={classes.companyDescription}>
          ...
          <div className={classes.summary}>
            <p>
              ...
              профилактическим мероприятиям. Наши пациенты знают, что
              профилактика лучше и дешевле, чем лечение.
            </p>
            <p>
            ...
            <p>
              ...
              и наблюдению является нормой в развитых странах, так как многие
